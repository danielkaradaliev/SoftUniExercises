...
def main():
    ...
    # food_orders_app = FoodOrdersApp()
    # new_client = Client("0888888888")
    # new_main_dish = MainDish("main_dish", 5.5)
    # another_new_main_dish = MainDish("another_main_dish", 5.5, 77)
    # new_dessert = Dessert("desert", 4)
    # more_dessert = Dessert("desert", 4, 44)
    # print(str(new_client))
    # print(new_main_dish.details())
    # print(another_new_main_dish.details())
    # print(new_dessert.details())
    # print(more_dessert.details())
    # print(food_orders_app.register_client("0899999999"))
    # print(food_orders_app.register_client("0899999999"))
